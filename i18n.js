(function () {
    ...
    const DICT = {
        ru: {
            ...
            'about.creds3.desc': 'Долгие годы тесного сотрудничества с застройщиками открывают клиентам доступ к лучшим вариантам — приоритет в выборе юнита, этажа и вида до публичного старта продаж.',
        ...
        en: {
            ...
            'about.creds3.desc': 'Long-standing close relationships with developers give clients access to the best units — priority on choice of layout, floor and view ahead of the public launch.',
