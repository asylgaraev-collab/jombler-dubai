(function () {
    ...
    const DICT = {
        ru: {
            ...
            'dubai.ul.downtown.desc': 'Главный адресный кластер города — Burj Khalifa, Dubai Opera, Dubai Mall. Высокая концентрация trophy-проектов с мировыми отельными брендами.',
            ...
            'dubai.ul.difc.desc': 'Финансовый центр и единственная зона Дубая под английским common law. Ставка на trophy от Waldorf Astoria, Ritz-Carlton, Four Seasons, Aman/Janu.',
            ...
            'dubai.ul.palm.desc': 'Самый престижный остров Дубая. Доминируют trophy-проекты класса Dorchester Collection (AVA, ORLA, Orla Infinity), Six Senses, Ellington и эксклюзивные boutique-launch’и.',
        ...
        en: {
            ...
            'dubai.ul.downtown.desc': 'The city’s prime address cluster — Burj Khalifa, Dubai Opera, Dubai Mall. High concentration of trophy projects with global hotel brands.',
            ...
            'dubai.ul.difc.desc': 'Dubai’s financial centre and the only zone under English common law. Focused on trophy projects from Waldorf Astoria, Ritz-Carlton, Four Seasons, Aman/Janu.',
            ...
            'dubai.ul.palm.desc': 'Dubai’s most prestigious island. Dominated by Dorchester Collection-class trophy projects (AVA, ORLA, Orla Infinity), Six Senses, Ellington and exclusive boutique launches.',
