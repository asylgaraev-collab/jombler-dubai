(function () {
    ...
    const DICT = {
        ru: {
            ...
            'about.story.title': 'Опыт, проверенный<br>годами на рынке ОАЭ',
        ...
        en: {
            ...
            'about.story.title': 'Experience built<br>over years in UAE real estate',
            ...
            'about.creds2.desc': 'I source properties on the primary market from developers and vetted offers on the secondary market — matched to client budget and goals.',
