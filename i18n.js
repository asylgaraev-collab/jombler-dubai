(function () {
    ...
    const DICT = {
        ru: {
            ...
            'about.creds1.desc': 'Все сделки регистрируются в Dubai Land Department и проходят через эскроу-счета согласно закону №8 о RERA.',
            'about.creds2.title': 'Активная работа на офф-план и секондарий',
            'about.creds2.desc': 'Подбираю объекты на первичном рынке от застройщиков и проверенные предложения на вторичке — под бюджет и цели клиента.',
            'about.creds3.title': 'Прямой доступ к лучшим предложениям',
            'about.creds3.desc': 'VIP-allocations до публичного launch, приоритет по этажам и видам, тихие resale-сделки от частных владельцев.',
            ...
            'about.creds5.title': 'Анализ для покупателей и продавцов',
            'about.creds5.desc': 'ROI, план рассрочки, потенциал роста, сравнительный анализ районов и проектов — на каждой стадии сделки.',
            'about.creds6.title': 'Работа со всем миром',
            'about.creds6.desc': 'Клиенты из России, СНГ, Европы, Великобритании и Азии. Все этапы — удалённо или с личной встречей в Дубае.',
            'about.creds7.title': 'Помощь с Emirates ID и Golden Visa',
            'about.creds7.desc': 'Сопровождение в получении Emirates ID и Golden Visa при покупке недвижимости — от подачи документов до выдачи резидентства.',
            ...
            'dubai.ul.col.cta': 'Узнать больше',
            'dubai.ul.cta.btn': 'Узнать больше о проекте',
            'dubai.ul.cta.text': 'Здравствуйте! Хочу узнать больше о проекте',
        ...
        en: {
            ...
            'about.creds1.desc': 'Every deal is registered with the Dubai Land Department and processed via escrow accounts under RERA Law No. 8.',
            'about.creds2.title': 'Active across off-plan and secondary',
            'about.creds2.desc': 'I source off-plan properties directly from developers and vetted secondary-market offers — matched to client budget and goals.',
            'about.creds3.title': 'Direct access to the best offers',
            'about.creds3.desc': 'VIP allocations before public launch, priority on floors and views, quiet resale deals from private owners.',
            ...
            'about.creds5.title': 'Analysis for buyers and sellers',
            ...
            'about.creds7.title': 'Emirates ID and Golden Visa support',
            'about.creds7.desc': 'Full assistance with Emirates ID and Golden Visa applications based on your property purchase — from paperwork to issued residency.',
            ...
            'dubai.ul.col.cta': 'Learn more',
            'dubai.ul.cta.btn': 'Learn more about the project',
            'dubai.ul.cta.text': 'Hello! I would like to learn more about',
